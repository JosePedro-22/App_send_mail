<?php
	...
	$mensagem->__set('contexto', $_POST['contexto']);
	...
	try {
        ...
        $message->status['descricao_status'] = 'Não foi possivel enviar este e-mail! Por favor tente novamente mais tarde.' . $mail->ErroInfo;
	}
